...
function UniversitiesPage() {
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setLiveTelemetry((prev) => {
        ...
        const escNum = Math.min(
          95,
          Math.max(35, parseInt(prev.esc) + (Math.random() > 0.5 ? 1 : -1)),
        );
  ...
  return (
    <div className="bg-[#050506] text-white overflow-hidden min-h-screen">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 mb-10 select-none">
          <Reveal>
            ...
            <p className="text-sm sm:text-base md:text-lg text-[#8A94A6] mt-6 max-w-2xl mx-auto leading-relaxed font-sans">
              Establish a state-of-the-art Drone Centre of Excellence on your campus. Fully
              equipped, credit-mapped, and staffed by industry professionals at zero capital
              investment.
            </p>
              ...
              <div className="p-5 sm:p-6 flex flex-col justify-between flex-grow">
                <div>
                  ...
                  <p className="text-sm text-[#8A94A6] mt-3 leading-relaxed font-sans">
                    Turn campus space into a fully functional training facility containing simulator
                    stations, component workbench setups, and indoor flight grids.
                  </p>
                </div>

                <div className="mt-4 pt-4 border-t border-[#222328]/60 grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-[10px] font-mono text-[#8A94A6] uppercase tracking-wider">
                      UGC Credits
                    </div>
            ...
            <div className="group rounded-xl overflow-hidden border border-[#222328] bg-[#0c0d0f] transition-all duration-300 hover:border-[#00F0FF]/40 flex flex-col h-full shadow-2xl relative">
                ...
                <div className="absolute inset-0 p-4 flex flex-col justify-between font-mono text-[9px] text-[#00F0FF]/85 select-none z-10">
                  ...
                  <div className="flex justify-between items-center w-full">
                    ...
                    <div className="bg-[#050506]/95 border border-[#222328] px-2.5 py-1 rounded flex items-center gap-1.5 shadow-[0_0_10px_rgba(0,240,255,0.05)]">
                      ...
                      />
                      <span className="font-bold tracking-wider text-[8px] text-white uppercase">
                        NAKSHATR
                      </span>
                    </div>
                  ...
                  <div className="flex justify-between items-end gap-2">
                    <div className="bg-[#050506]/95 border border-[#222328] px-2.5 py-1.5 rounded grid grid-cols-2 gap-x-3 gap-y-0.5 text-left max-w-[150px] sm:max-w-none">
                      <div>
                        PITCH: <span className="text-white font-bold">{liveTelemetry.pitch}°</span>
                      </div>
                      <div>
                        YAW: <span className="text-white font-bold">{liveTelemetry.yaw}°</span>
                      </div>
                      <div>
                        ROLL: <span className="text-white font-bold">{liveTelemetry.roll}°</span>
                      </div>
                      <div>
                        ALT: <span className="text-white font-bold">{liveTelemetry.alt}m</span>
                      </div>
                    </div>
                    <div className="bg-[#050506]/95 border border-[#222328] px-2.5 py-1.5 rounded text-right whitespace-nowrap">
                      <div>
                        ESC TEMP:{" "}
                        <span className="text-white font-bold">{liveTelemetry.esc}°C</span>
                      </div>
                      <div>
                        BATTERY:{" "}
                        <span className="text-white font-bold">{liveTelemetry.battery}%</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-5 sm:p-6 flex flex-col justify-between flex-grow">
                <div>
                  ...
                  <p className="text-sm text-[#8A94A6] mt-3 leading-relaxed font-sans">
                    Equip your students with type-certified multirotors, active flight transmitters,
                    field ground stations, and battery diagnostics safety gear.
                  </p>
                </div>
      ...
      <section className="bg-[#050506] py-12 border-b border-[#222328]/60 relative">
          ...
          <Reveal>
            <div className="tech-card animate-hud-hover-float group rounded-lg p-6 h-full relative overflow-hidden bg-[#16171A] border border-[#222328] hud-card-corners">
              ...
              <p className="text-[#8A94A6] mt-4 leading-relaxed text-sm relative z-10 font-sans">
                UAV technology education in India is heavily fragmented, consisting primarily of
                brief seminars and passive video presentations. Students lack true flight
                diagnostics, controller programming skills, and operational hours. Our
                university-embedded labs provide direct physical assembly configurations, flight
                logging systems, and DGCA exam mock paths to produce deployable flight assets.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <div className="tech-card animate-hud-hover-float group rounded-lg p-6 h-full relative border-t-4 border-[#222328] bg-[#16171A] hover:border-t-[#00F0FF] flex flex-col justify-center overflow-hidden hud-card-corners">
              ...
              <p className="mt-2 text-[#8A94A6] text-sm leading-relaxed font-sans relative z-10">
                of drone academy graduates in India are prepared for real industrial workflows on
                Day 1. Our Centre of Excellence bridges this operational readiness gap.
              </p>
            </div>
          </Reveal>
        </div>
      ...
      <section id="benefits" className="bg-[#16171A] py-12 border-b border-[#222328]/60 relative">
          ...
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-10 select-none">
              ...
              <p className="mt-4 text-[#8A94A6] text-sm sm:text-base leading-relaxed">
                Complete hardware labs, credit mappings, joint branding certification, and
                continuous student revenue share schemes.
              </p>
            </div>
          </Reveal>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <Reveal>
            <div className="text-center max-w-3xl mx-auto mb-10 select-none">
              ...
              <p className="mt-4 text-[#8A94A6] text-sm sm:text-base leading-relaxed">
                Our team handles MoU execution, hardware lab construction, curriculum licensing, and
                certification delivery.
              </p>
            </div>
          </Reveal>

          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch relative">
            {[
              {
                n: 1,
                icon: FileSignature,
                title: "MoU Alignment",
                desc: "Mutually structured partnership terms, credit values, and revenue share models.",
              },
              {
                n: 2,
                icon: Wrench,
                title: "Lab Setup Operations",
                desc: "We deploy standard simulators, calibration tools, flight transmitters, and carbon-frame training drones.",
              },
              {
                n: 3,
                icon: TrendingUp,
                title: "Deploy & Joint Certify",
                desc: "Deliver high-fidelity credit-bearing cohorts, issue certifications, and route to sector jobs.",
              },
            ].map((s, i) => (
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <Reveal>
            ...
            <p className="text-[#8A94A6] mt-6 text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed font-sans">
              Schedule an operational review with our partnerships team to evaluate MoU structures,
              university-embedded spacing requirements, and local UGC framework credits.
            </p>
