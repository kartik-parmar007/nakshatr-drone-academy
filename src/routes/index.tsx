...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "drone academy, uav engineering, dgca remote pilot license, drone training india, drone school gujarat, mkbu drone course, aerial cinematography, drone building" },
      ...
      { name: "twitter:description", content: "Futuristic flight training, cinematic storytelling, and advanced drone engineering." },
      { name: "twitter:image", content: "/dawn_mountain_landscape.webp" }
    ],
    links: [
      { rel: "canonical", href: "https://nakshatr.tech/" }
    ]
  }),
});
