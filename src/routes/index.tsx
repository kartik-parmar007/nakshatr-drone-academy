    ...
    <div>
      ...
      <section className="bg-white bg-dot-grid border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-24 grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
          <div>
            <motion.span
              ...
              className="inline-flex items-center gap-2 bg-blue-50 border border-blue-200/60 text-blue-700 text-[10px] sm:text-xs font-mono font-semibold px-2.5 sm:px-3 py-1.5 rounded mb-4 sm:mb-5 tracking-wider uppercase"
            >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-blue-950 leading-tight tracking-tight"
            >
            ...
            <motion.p
              ...
              className="mt-4 sm:mt-5 text-base sm:text-lg text-gray-600 max-w-xl leading-relaxed"
            >
            ...
            >
              <Link
                to="/programs"
                className="bg-blue-600 hover:bg-blue-700 text-white px-5 sm:px-6 py-2.5 rounded-md font-semibold font-mono text-xs sm:text-sm uppercase tracking-wider shadow-sm transition-all hover:shadow inline-flex items-center gap-2"
              >
                Explore Programs <ArrowRight size={16} />
              </Link>
              <Link
                to="/universities"
                className="border border-blue-600 text-blue-600 hover:bg-blue-50 px-5 sm:px-6 py-2.5 rounded-md font-semibold font-mono text-xs sm:text-sm uppercase tracking-wider transition-colors"
              >
                Partner With Us
              </Link>
            </motion.div>
          ...
          <div className="relative flex justify-center items-center order-first lg:order-last">
            <div className="absolute bottom-2 sm:bottom-4 w-3/4 h-6 sm:h-8 bg-blue-400/30 blur-3xl rounded-full" />
            <motion.div
        ...
        <div className="border-t border-slate-100 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex flex-wrap items-center justify-center gap-x-4 sm:gap-x-8 gap-y-2 text-[10px] sm:text-xs font-mono uppercase tracking-wider text-blue-800">
      ...
      <section className="bg-white py-14 sm:py-16 lg:py-20 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-950 text-center uppercase tracking-tight">
              The Drone Industry in India
            </h2>
            <p className="text-gray-500 text-center mt-3 max-w-2xl mx-auto text-xs sm:text-sm leading-relaxed px-2">
          ...
          <div className="mt-10 sm:mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {stats.map((s, i) => (
              <Reveal key={s.label} delay={i * 0.08}>
                <div className="tech-card rounded-md p-5 sm:p-6 relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-2 font-mono text-[9px] text-blue-300 select-none">
                    SYS-STAT-{i + 1}
                  </div>
                  <s.icon className="text-blue-600 mb-3 sm:mb-4" size={28} />
                  <div className="font-semibold text-blue-950 text-sm sm:text-base leading-snug tracking-tight">{s.label}</div>
                </div>
              </Reveal>
            ))}
          </div>
      ...
      {/* Use cases */}
      <section className="bg-white py-14 sm:py-16 lg:py-20 bg-dot-grid border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-950 text-center uppercase tracking-tight">
          ...
          <div className="mt-10 sm:mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {useCases.map((u, i) => (
              <Reveal key={u.title} delay={i * 0.05}>
                <div className="tech-card rounded-md p-5 sm:p-7 h-full flex flex-col justify-between">
                  <div>
                    <div className="flex justify-between items-start mb-3 sm:mb-4">
                      <u.icon className="text-blue-600" size={28} />
                      <span className="font-mono text-[10px] text-blue-500 font-semibold bg-blue-50/50 border border-blue-100 px-2 py-0.5 rounded">
                        OP-MOD-0{i + 1}
                      </span>
                    </div>
                    <h3 className="text-base sm:text-lg font-bold text-blue-950">{u.title}</h3>
          ...
          <div className="mt-10 sm:mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {audiences.map((a, i) => (
              <Reveal key={a.title} delay={i * 0.1}>
                <div className="tech-card rounded-md p-6 sm:p-8 text-center flex flex-col items-center">
                  <div className="w-12 h-12 rounded-md bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 mb-5 sm:mb-6 shadow-inner">
                    <a.icon size={24} />
                  </div>
                  <h3 className="text-base sm:text-lg font-bold text-blue-950">{a.title}</h3>
          ...
          <div className="mt-10 sm:mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {news.map((n, i) => (
              <Reveal key={n.title} delay={i * 0.08}>
                <article className="tech-card rounded-md p-5 sm:p-6 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-base sm:text-lg font-bold text-blue-950 mt-4 leading-snug">{n.title}</h3>
                    <p className="text-gray-600 text-sm mt-2 leading-relaxed">{n.desc}</p>
                  </div>
                  <a className="text-blue-600 font-semibold text-xs font-mono uppercase mt-5 sm:mt-6 inline-flex items-center gap-1.5 hover:text-blue-800 transition-colors cursor-pointer">
