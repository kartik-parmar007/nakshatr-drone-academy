  ...
  head: () => ({
    meta: [
      { title: "Our Philosophy — Reverse Engineering UAV Pedagogy" },
      {
        name: "description",
        content:
          "We place a drone in a student's hands before a single lecture is delivered. Learn our core reverse-engineering flight instruction pedagogy.",
      },
      {
        name: "keywords",
        content:
          "drone learning pedagogy, learn uav mechanics, reverse engineering drones, drone flight physics",
      },
    ...
    links: [{ rel: "canonical", href: "https://nakshatr.tech/philosophy" }],
  }),
});
