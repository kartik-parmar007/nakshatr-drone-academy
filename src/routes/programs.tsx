...
export const Route = createFileRoute("/programs")({
  head: () => ({
    meta: [
      ...
      { name: "keywords", content: "drone course syllabus, dgca license program, uav robotics certification, aerial photography course, gis mapping drones, university credit course" },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "Our Drone Education Programs" },
      { property: "og:description", content: "UGC aligned, DGCA compliant, MKBU certified drone education programs from Hardware Mastery to Industry Ready." },
      ...
      { name: "twitter:description", content: "UGC aligned, DGCA compliant, MKBU certified drone education programs from Hardware Mastery to Industry Ready." },
      { name: "twitter:image", content: "/dawn_mountain_landscape.webp" }
    ],
    links: [
      { rel: "canonical", href: "https://nakshatr.tech/programs" }
    ]
  }),
});
